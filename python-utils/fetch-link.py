...
from pycurl_requests import get, Session
...
def fetchurl(url):
    return BeautifulSoup(
        ...
        url, 
        headers = 
        {'User-Agent': 'Mozilla/5.0 (Linux; Android 10) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.5414.86 Mobile Safari/537.36'}).text, 
        'html.parser')
