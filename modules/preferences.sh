...
preferences() {
    PREFERENCES_ARRAY=("LIGHT_THEME" "$LIGHT_THEME" "PREFER_SPLIT_APK" "$PREFER_SPLIT_APK" "LAUNCH_APP_AFTER_MOUNT" "$LAUNCH_APP_AFTER_MOUNT" ALLOW_APP_VERSION_DOWNGRADE "$ALLOW_APP_VERSION_DOWNGRADE" "ALLOW_PRERELEASED_ASSETS" "$ALLOW_PRERELEASED_ASSETS")
